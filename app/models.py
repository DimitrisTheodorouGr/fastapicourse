...
class HealthRec(Base):
    ...
    head_abscesses = Column(Boolean, default=False)
    fibrosis = Column(Boolean, default=False)
    breast_assymmetry = Column(Boolean, default=False)
    mammary_skin_conditions = Column(Boolean, default=False)
    cmt_a = Column(Integer)
    cmt_d = Column(Integer)
